...
static port_map_t port_table_pcb8398[] = {
        ...
        {16, MESA_MIIM_CONTROLLER_NONE, 0, MESA_PORT_INTERFACE_SFI,  LAGUNA_CAP_10G_FDX,            MESA_BW_10G, 24, 0, 0},
        {17, MESA_MIIM_CONTROLLER_NONE, 0, MESA_PORT_INTERFACE_SFI,  LAGUNA_CAP_10G_FDX,            MESA_BW_10G, 25, 1, 0},
};
                            ...
                            const meba_board_interface_t *callouts)
{
    ...
    board->type = BOARD_TYPE_LAGUNA_PCB8398;
    ...
    init_port_table(inst, port_cnt, port_table_pcb8398);
    ...
    inst->api.meba_ptp_rs422_conf_get         = NULL;
    inst->api.meba_gpio_func_info_get         = NULL;
    inst->api_synce                           = NULL;
    inst->api_tod                             = NULL;
    inst->api_poe                             = NULL;
